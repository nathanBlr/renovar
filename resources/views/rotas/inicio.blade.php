...
<div class="relative">
    ...
    <div id="default-carousel" class="relative w-full h-screen bg-slate-600" data-carousel="static">
        ...
        <div class="absolute z-30 flex -translate-x-1/2 bottom-5 left-1/2 space-x-3 rtl:space-x-reverse">
            ...
            <div
            class="inline-flex rounded-md shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 motion-reduce:transition-none"
            role="group">
            <button type="button" class="inline-block rounded-s bg-[#E5E7EB] px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal text-[#68c8e3] hover:text-gray-800 transition duration-150 ease-in-out hover:bg-primary-accent-300 focus:bg-primary-accent-300 focus:outline-none focus:ring-0 active:bg-primary-600 motion-reduce:transition-none" data-twe-ripple-init data-twe-ripple-color="light" data-carousel-prev>
                <span class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-inherit group-hover:bg-white/50 group-focus:ring-4 group-focus:ring-white group-focus:outline-none">
                  <svg class="w-4 h-4 bg-inherit rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
...
<!-- Noticias -->
<hr class="my-12 h-0.5 border-t-0 bg-[#68c8e3]"/>
<section id="noticias" class="container mx-auto mt-16">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="card rounded-lg shadow-md p-4">
      <img src="{{ asset('storage/' .$noticia1->image_path) }}" alt="Imagem da Notícia 1" class="w-full h-200 object-cover object-center rounded-lg mb-4">
      <h3 class="text-lg font-bold mb-2 text-center">{{ $noticia1->title }}</h3>
  </div>
  <div class="card rounded-lg shadow-md p-4">
      <img src="{{ asset('storage/' .$noticia2->image_path) }}" alt="Imagem da Notícia 2" class="w-full h-200 object-cover object-center rounded-lg mb-4">
      <h3 class="text-lg font-bold mb-2 text-center">{{ $noticia2->title }}</h3>
  </div>
    @endif
...
<!-- Documentação -->
  ...
  <section id="documentacao" class="container mx-auto mt-8 bg-gray-100 py-4 sm:py-8">
    <div class="max-w-full bg-white border border-gray-200 rounded-lg shadow flex flex-col sm:flex-row">
        ...
        <div class="p-4 sm:p-5 flex-1 flex flex-col justify-between">
            <div>
                <a >
                    <h5 class="mb-2 text-xl sm:text-2xl font-bold tracking-tight text-gray-900 text-center">Em Busca De Documentação?</h5>
                </a>
                <p class="mb-3 font-normal text-gray-700 text-sm sm:text-base pt-5">Aqui você encontra todos os documentos relacionados à nossa instituição. Explore uma coleção abrangente que abrange diversas áreas de interesse e mantenha-se atualizado com as informações mais recentes. Descubra mais sobre nossas iniciativas, projetos e muito mais.</p>
            </div>
            <a href="{{ route('rotas.index', 'documentacao')}}" class="inline-block w-full sm:w-auto items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#68c8e3] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                Documentação
...
<section class="w-full mx-auto mt-16 bg-gray-100 py-8">
  <div class="w-full bg-white border border-gray-200 rounded-lg shadow p-6">
      <div class="flex flex-col items-center justify-center text-center mb-6">
          <h2 class="text-4xl md:text-6xl font-bold mb-4">Busca Mais Informações?</h2>
          <p class="mb-6 font-bold text-[#68c8e3] text-lg md:text-2xl">Entre em contato por meio de nossas redes sociais</p>
      </div>
      <div class="flex flex-col md:flex-row justify-around mb-6">
          <img class="w-full md:w-1/4 rounded-lg mb-4 md:mb-0" src="{{ asset('Fotos/getty_991166232_2000135220009280424_402970.jpg') }}" alt="Imagem 1" />
          <img class="w-full md:w-1/4 rounded-lg mb-4 md:mb-0" src="{{ asset('Fotos/Wooden_There-Is-No-Greater-Joy-in-Life-Than-Helping-Others-1024x682.jpg') }}" alt="Imagem 2" />
          <img class="w-full md:w-1/4 rounded-lg mb-4 md:mb-0" src="{{ asset('Fotos/Customer_care.jpg') }}" alt="Imagem 3" />
      </div>
...
<section id="projetos" class="container mx-auto mt-16 bg-white py-8">
    <div class="flex flex-col items-center justify-center text-center">
        <h2 class="text-6xl font-bold mb-4">Junte-se a nós e faça a diferença!</h2>
        <p class="text-gray-700 text-[30px] mb-6">Seja um voluntário, faça uma doação ou participe de um dos nossos eventos.</p>     
        <a href="{{ route('rotas.index','projetos') }}" class="loading-link flex flex-col md:flex-row items-center w-full mb-6 border text-gray-900 border-gray-200 rounded-lg shadow hover:text-[#68c8e3] hover:bg-gray-200 focus:bg-gray-300 transition duration-300 ease-in-out">
            <img class="w-48 h-48 md:w-48 md:h-auto rounded-lg shadow-lg md:mr-4" src="{{ asset('Fotos/05.jpg') }}" alt="Bonnie image"/>
            <div class="p-4">
                <h5 class="mb-2 text-2xl font-bold tracking-tight font-fredericka">Noteworthy technology acquisitions 2021</h5>
                <p class="mb-3 font-normal font-serif">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
            </div>
        </a>
        <a href="{{ route('rotas.index','projetos') }}" class="loading-link flex flex-col md:flex-row items-center w-full mb-6 border text-gray-900 border-gray-200 rounded-lg shadow hover:text-[#68c8e3] hover:bg-gray-200 focus:bg-gray-300 transition duration-300 ease-in-out">
...
<section class="container mx-auto mt-16 bg-gray-100 py-8" >
  ...
  <div class="flex flex-col md:flex-row col-span-3 items-center justify-center text-center">
    ...
    <div class="md:w-1/3 mx-2 mb-4">
        <div class="bg-white border border-gray-200 rounded-lg shadow p-5">
          <img src="{{ asset('Fotos/felicidade-alegre-mulher-.avif') }}" alt="Assistência a Idosos Image" class="w-full h-48 object-cover rounded-t-lg">
          <div class="p-4">
